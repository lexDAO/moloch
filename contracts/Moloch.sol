...
contract Moloch is ReentrancyGuard {
    ...
    ***************/
    ...
    uint256 public summoningRate; // rate for members to convert tribute into shares before summoning termination (default = 100000000000000000 wei amt. // 1 wETH => 10 shares)
